...
{
    public class 潋滟药水 : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Water Power Potion");
            //DisplayName.AddTranslation(7, "潋滟药水");
            // Tooltip.SetDefault("20% increased Water magic damage");
            //Tooltip.AddTranslation(7, "水魔法伤害提高20%");
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<Buffs.潋滟buff>(); // 药剂的buff类型，这个是魔力再生药水的效果
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            foreach (TooltipLine line2 in tooltips)
            {
                ...
                {
                    Color c = 伊蕾娜.SkillDamageColor(伊蕾娜.HitType.HitByWater);
