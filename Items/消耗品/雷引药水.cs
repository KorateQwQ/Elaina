...
{
    public class 雷引药水 : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Lightning Power Potion");
            //DisplayName.AddTranslation(7, "雷引药水");
            // Tooltip.SetDefault("20% increased Lightning magic damage and increase the frequency of lightning");
            //Tooltip.AddTranslation(7, "雷魔法伤害提高20%, 提高雷击的频率");
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<雷引buff>(); // 药剂的buff类型，这个是魔力再生药水的效果
