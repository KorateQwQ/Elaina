...
{
    public class 寒霜药水 : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Ice Power Potion");
            //DisplayName.AddTranslation(7, "寒霜药水");
            // Tooltip.SetDefault("20% increased Ice magic damage");
            //Tooltip.AddTranslation(7, "冰魔法伤害提高20%");
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<Buffs.寒霜buff>(); // 药剂的buff类型，这个是魔力再生药水的效果
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            foreach (TooltipLine line2 in tooltips)
            {
                ...
                {
                    Color c = Color.Transparent; //伊蕾娜.SkillDamageColor(伊蕾娜.HitType.HitByIce);//伊蕾娜.SkillDamageColor(伊蕾娜.HitType.HitByIce)
